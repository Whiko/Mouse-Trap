...
{	
    ...
    {
    	pacM= new Image ("pacM.png");
        fantome = new Image("fantomebleu.png");
        son= new Image("son.png");
        activer= new Image("activer.png");
        desactiver=new Image("desactiver.png");
        commandes=new Image("commandes.png");
        MScores=new Image("MScores.png");
        retour= new Image("retour.png");
    }
